...
IMAGE_BASE = "https://image.tmdb.org/t/p/w500"  # High-res posters
...
category = st.sidebar.selectbox("Category", ["Popular", "Top Rated", "Upcoming"])
...
# Display Movies
st.subheader(f"{category} Movies ({year})")
